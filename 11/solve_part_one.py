...
def read_input(file_name: str = "input.txt"):

    lines_input = open(file_name, "r").readlines()
...
def inspect_items(monkey: Monkey, monkeys: Dict[int, Monkey]) -> Dict[int, Monkey]:
    ...
    for item in monkey.items:
        ...
        # monkey gets bored with item, divide by 3
        new_item = new_item // 3
...
def monkey_business(monkeys_data: Dict, rounds: int = 20):
    monkeys = {}
    ...
    for _ in range(rounds):
        for monkey in monkeys.values():
            monkeys = inspect_items(monkey, monkeys)
...
if __name__ == "__main__":
    ...
    monkeys = monkey_business(monkeys_data, rounds=20)
